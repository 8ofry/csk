...
const traineesList = [
  ...
  { nameAr: "آسر حازم", nameEn: "Aser Hazem", phone: null, dob: new Date("2021-01-01") }, // phone null to avoid conflict with Omar Hazem
...
const TARGET_GROUP_ID = "cmplzzcce0001b82aduql3nfn"; // The new ID of النادي الساعة 9
...
async function main() {
  ...
  console.log("\nAll trainees enrolled successfully under new Group ID!");
}
